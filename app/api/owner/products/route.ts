...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const sanitizedData = {
      ...
      brand,
      model,
      variant: body.variant ? sanitizeString(body.variant, 100) : undefined,
      ram: body.ram ? sanitizeString(body.ram, 50) : undefined,
      storage: body.storage ? sanitizeString(body.storage, 50) : undefined,
