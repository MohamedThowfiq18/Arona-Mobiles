    ...
    <div className="pt-28 pb-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 text-left">
      ...
      {usedProducts.length > 0 ? (
        ...
        <div className="bg-slate-50 border border-dashed border-slate-200 rounded-3xl p-12 text-center space-y-2">
          <p className="font-heading font-bold text-slate-700">No pre-owned mobiles listed yet</p>
          <p className="text-slate-500 text-xs">Certified used devices are listed directly by the store owner.</p>
        </div>
      )}
